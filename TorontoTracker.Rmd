...
acqBreakdown$colors <- c("#E01E5A", "#4285F4", "#767676", "#0F9D58", "#F4B400")
```
...
### <b> Breakdown </b> 
```{r}
plot_ly(acqBreakdown, labels = ~Case_AcquisitionInfo, values = ~n, 
        type = 'pie',
        textposition = 'inside',
        textinfo = 'label+percent',
        insidetextfont = list(color = '#FFFFFF'),
...
plot_ly(data = cacot, x = ~Case_Reported_Date, y = ~CC_Pct, 
  ...
  layout(title = "",
         yaxis = list(title = '% of Daily Cases'),
         xaxis = list(title = ' ', rangeselector = list(buttons = buttons_time)),
         hovermode = "x unified", 
...
#### <b> Code </b>
Codebase and dataset used to generate this web application are available on [Github](https://github.com/Erebus54/Toronto-Covid19-Tracker-Dashboard).
